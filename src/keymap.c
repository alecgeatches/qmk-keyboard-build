...
// // Regular animations
#include "animation/utility.h"
// #include "animation/gradient-breathe.h"
// #include "animation/rainbow-home-keys.h"
// #include "animation/scanning.h"
// #include "animation/plasma.h"
// #include "animation/tron.h"

// // Reactive animations
// #include "animation/utility-reactive.h"
// #include "animation/reactive-heatmap.h"
// #include "animation/reactive-sparks.h"
...
void alecg_run_custom_animation(bool initialize_animation) {
  ...
  if(alecg_custom_animation == ALECG_CUSTOM_ANIMATION_OFF) {
  ...
  } else if(alecg_custom_animation == ALECG_CUSTOM_ANIMATION_REACTIVE_SPARKS) {
    alecg_animate_reactive_sparks();
  #endif
    ...
    alecg_animate_gradient_breathe(g_rgb_counters.tick);
  #endif
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  // for (uint8_t led_i = 0; led_i < DRIVER_LED_TOTAL; led_i++) {
  //   matrix_co = g_rgb_leds[led_i].matrix_co;

  //   if (row == matrix_co.row && column == matrix_co.col) {
  //     alecg_reactive_process_key(led_i, record->event.pressed);
  //     break;
  //   }
  // }
